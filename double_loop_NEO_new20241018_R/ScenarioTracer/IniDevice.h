...
private:
    ...
    /* 静的インスタンス */
    ev3api::GyroSensor  mResetRollAngle;            // リセットロール角
    ev3api::Motor       mStopForLeftMotor;          // 停止用左モータ
    ev3api::Motor       mStopForRightMotor;         // 停止用右モータ
    ev3api::Motor       mResetForLeftMotorEncoder;  // リセット用左モータエンコーダ
    ev3api::Motor       mResetForRightMotorEncoder; // リセット用右モータエンコーダ
